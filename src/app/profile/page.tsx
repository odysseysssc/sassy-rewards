...
export default function Profile() {
  ...
  }, [session?.user?.id, fetchAddress, fetchCredentials]);
    ...
    <main className="min-h-screen">
      ...
      <section className="max-w-2xl mx-auto px-4 md:px-6 lg:px-12 py-16 md:py-20">
        ...
        <div className="card-premium rounded-xl p-6 mb-6">
            ...
            {displayWallet ? (
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-gold text-xs hover:underline disabled:opacity-50"
                >
                  {walletLinking ? 'Linking...' : 'Connect'}
                </button>
              </div>
            )}
          ...
          {walletLinkError && (
            <p className="text-red-400 text-sm mt-4">{walletLinkError}</p>
          )}
        </div>
        ...
        {/* Shipping Address - Only show for email users */}
        {displayEmail && (
          <div className="card-premium rounded-xl p-6 mb-6">
            <h2 className="text-lg font-semibold text-white mb-2">Shipping Address</h2>
            <p className="text-white/50 text-sm mb-4">
              Win a Pin Wheel spin? We&apos;ll need your address to send your enamel pin!
            </p>
            ...
            {addressLoading ? (
              ...
              <form onSubmit={handleSaveAddress} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-white/70 text-sm mb-1">ZIP/Postal Code</label>
                    <input
                      type="text"
